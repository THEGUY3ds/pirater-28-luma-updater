...
ReleaseInfo releaseGetLatestStable() {
	...
	release.versions.push_back(ReleaseVer{ "CITRA", "CITRA", "https://github.com/Pirater12/luma-nightlies/releases/tag/62-luma3ds-f776c56cd4cf212a7e789d4abb1ca551fce800ef", 143234 });
#else

	static const char* ReleaseURL = "https://github.com/Pirater12/luma-nightlies/releases/latest";
...
ReleaseInfo releaseGetLatestHourly() {
	...
	// Citra doesn't support HTTPc right now, so just fake a successful request
	hourly.name = "aaaaaaa";
	hourly.versions.push_back(ReleaseVer{ "CITRA", "latest hourly (aaaaaaa)", "https://github.com/Pirater12/luma-nightlies/releases/tag/62-luma3ds-f776c56cd4cf212a7e789d4abb1ca551fce800ef", 143234 });*/
